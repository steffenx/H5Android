...
public class HistoryCurveActivity extends AppCompatActivity implements ITimeCurveView{

    private WebView webview;
    private android.support.v7.widget.Toolbar toolbar;
    private TimeCurvePresenter timeCurvePresenter_History;
    private String devices_content;//传感器数据名称
    private String TAG="HistoryCurveActivityDebug";
    String myfirsttime,mysecondtime;
    ...
    private void setPreenter() {
        this.timeCurvePresenter_History = new TimeCurvePresenter(this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_control:
                ...
                i.setClass(HistoryCurveActivity.this,TimeCurveActivity.class);
                startActivity(i);
                finish();
                break;
            case R.id.action_contro2:
                ...
                i1.setClass(HistoryCurveActivity.this,YearOnYearCurveActivity.class);
                startActivity(i1);
                finish();
                break;
        }
    ...
    public void initMixedPage() {
        ...
        webview.loadUrl(HtmlUrl.historycurveHtmlUrl);
    ...
    @JavascriptInterface
    public void get_data(String firsttime ,String secondtime){
        Log.d(TAG, "get_data: "+firsttime+"="+secondtime);
        myfirsttime=firsttime;
        mysecondtime=secondtime;
        timeCurvePresenter_History.HistoryCurve(HistoryCurveActivity.this);
    }

    @Override
    public String get_devices() {
        String devices_id= getIntent().getStringExtra("devices_id");
        String account=(String) SharedPreferencesUtil.getmInstance().get(HistoryCurveActivity.this,"account","失败");
        ...
        if(!account.equals("失败")){
            ...
            jo.addProperty("start_time",Integer.parseInt(myfirsttime));
            jo.addProperty("end_time",Integer.parseInt(mysecondtime));
    ...
    public void onGetDataSeccess(String postRealtimeData, String terminalid) {
        Log.d(TAG, "onGetDataSeccess: "+postRealtimeData+"----"+terminalid);
    ...
    protected void onDestroy() {
        ...
        handler=null;
        this.timeCurvePresenter_History.onDestory();
        this.timeCurvePresenter_History.onDestory();
        this.timeCurvePresenter_History = null;//解除持有关系
        System.gc();
    }
